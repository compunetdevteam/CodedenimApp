...
namespace CodedenimWebApp.Controllers
{
    public class TestQuestionsController : Controller
    {
        ...
        {
            var testQuestions = db.TestQuestions.Include(t => t.Course);
        ...
        public async Task<ActionResult> Create([Bind(Include = "TestQuestionId,QuestionContent,QuestionInstruction,CourseId")] TestQuestion testQuestion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TestQuestionId,QuestionContent,QuestionInstruction,CourseId")] TestQuestion testQuestion)
        {
            if (ModelState.IsValid)
            {
